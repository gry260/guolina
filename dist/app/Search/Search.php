<div class="card" data-exclude="xs,sm,lg" style="padding-top: 15px; padding-bottom: 15px;">
  ...
  <div class="row">
    <div class="col-3" *ngFor="let item of Reports; let i = index">
      <canvas baseChart [labels]="labels" [data]="data" [colors]="colorsUndefined" [chartType]="type"></canvas>
    </div>
  </div>

{{label}}
  <div class="row">
    <div class="col-3" *ngFor="let item of label; let i = index">
  ...
  <div class="d-flex">
    <div class=" ml-2">
      <label>Price
        <select class="form-control form-control-sm" name="poperator1"
                #poperator1>
          <option>≈</option>
          <option>=</option>
          <option><</option>
    ...
    <div class=" ml-1">
      <label>&nbsp;
        <input type="text" class="form-control form-control-sm" name="price1"
               #price1 (input)="OnClickUpdatePrice(poperator1.value, price1.value, 0)"/>
      </label>
    </div>
    <div class=" ml-1 mr-1">
      <label>&nbsp;
    ...
    <div class="">
      <label>&nbsp;
        <select class="form-control form-control-sm" name="poperator2"
                #poperator2>
          <option>≈</option>
          <option>=
          </option>
    ...
    <div class="ml-1">
      <label>&nbsp;
        <input type="text" class="form-control form-control-sm" name="price2"
               #price2 (keyup)="OnClickUpdatePrice(poperator2.value, price2.value, 1)"/>
      </label>
    </div>
  </div>
  <div class="d-flex">
    <div class=" ml-2">
      <label>Last Time
        <select class="form-control form-control-sm" name="last_name"
                #lasttime (change)="OnChangeLastTime(lasttime.value)">
          <option></option>
  ...
  <div class="d-flex">
    <div class=" ml-2">
      ...
      <input type="text" class="form-control form-control-sm"
             (click)="from.toggle()" name="dp" ngbDatepicker #from="ngbDatepicker" ngModel
             (ngModelChange)="onDateFromChange($event)"/>
    </div>
    <div class=" ml-1">
      <label style="margin-bottom: 0px;">Until</label>
      <input type="text" class="form-control form-control-sm" ng-change="selectDate(dt)" ngModel
             (ngModelChange)="onDateUntilChange($event)"
             (click)="end.toggle()" name="dp" ngbDatepicker #end="ngbDatepicker"/>
    </div>
